<template>
  <div class="container mx-auto p-6">
    <h1 class="text-4xl font-extrabold mb-8 text-gray-800">Reporte de Horas Pico de Reservas</h1>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
      ...
      <div v-else class="mt-6 text-gray-500">No se encontraron datos de horas pico para el rango de fechas seleccionado.</div>
    </div>
  </div>
</template>
